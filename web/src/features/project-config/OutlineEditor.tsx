          ...
          <div id={fieldId("analysts")}>
            <p className="mb-1 flex items-center gap-1 text-[11px] text-fg-tertiary">
              ...
              <HelpTip title="담당 에이전트란?">
                ...
                <p>
                  안 고르면 기본 규칙만 적용되고 <b>목표 분량이 없어 절이 짧아집니다</b>.
                  <b> 절당 2~3개를 권장합니다</b> - 실측에서 1개짜리 절은 근거 20~24개로 목표
                  분량의 60~75%에 그쳤고, 여러 관점을 준 절은 근거 75개로 목표를 채웠습니다.
                </p>
                <p>
                  많이 넣을수록 검색이 여러 벌 돌아 <b>비용이 늘고</b>(실측 절당 +50~70%) 효율은
                  3개 언저리부터 꺾입니다. 3개 초과는 경고가 뜨고, 8개 초과는 저장되지 않습니다.
                </p>
              </HelpTip>
            </p>
            <AnalystPicker
